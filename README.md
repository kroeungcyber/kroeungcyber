...
Six years running production IT infrastructure and security for an international NGO in Cambodia (Microsoft 365/Entra, DLP, network hardening, data-lifecycle automation), now applying those same principles to machine learning deployment.
...
|---|---|---|---|
| [secure-rag](https://github.com/kroeungcyber/secure-rag) | RAG document Q&A for civil society orgs: denied-by-default auth, PII redaction, full audit logging, role-based multi-user onboarding, offline-capable | FastAPI · SQLite vec0/FTS5 · Ollama · Docker | [![CI](https://github.com/kroeungcyber/secure-rag/actions/workflows/ci.yml/badge.svg)](https://github.com/kroeungcyber/secure-rag/actions/workflows/ci.yml) |
...
Formalising this work toward a master's at a Swiss university of applied
sciences — ZHAW, BFH, FHNW, or HSLU — programmes that prize the real-world,
practice-oriented experience this portfolio demonstrates. Admissions case in
preparation.
